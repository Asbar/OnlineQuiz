...
var TaskComponent = (function () {
    function TaskComponent(taskService) {
        ...
        this.taskitems = [];
        this.taskService.getTasks().subscribe(function (data) { _this.taskitems = data; }, function (err) { return _this.logError(err); }, function () { return _this.taskitems.forEach(function (element) {
